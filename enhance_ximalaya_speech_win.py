...
# 设置输入和输出目录
input_dir = r"\\192.168.2.33\base\data1\data\speech\crawled\temp\temp_ximalaya_for_process"
output_dir = r"\\192.168.2.33\base\data1\data\speech\crawled\temp\temp_ximalaya_for_process_enhanced"
